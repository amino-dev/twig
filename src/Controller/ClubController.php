...
class ClubController extends AbstractController
{
    ...
    /**
     * @Route("/club/{nom}", name="getname")
     */
    public function getName($nom)
    {
        return $this->render('club/detail.html.twig',["key"=>$nom]);
    }
    ...
    function Liste(){
        ...
        'nb_participants'=>0),
        array('ref'=>'form178','Titre'=>'Formation Angular' ,'Description'=>'formation
        theorique','date_debut'=>'10/06/2020','date_fin'=>'14/06/2020',
        'nb_participants'=>12)];
        return $this->render("club/list.html.twig",['formation'=>$formations]);
    }   
}
